...
public final class QualifiedName {
     ...
     * {@code gmail}. Derived through {@link io.ballerina.tools.discover.model.ModuleRef} so there is one definition of
     * the rule, shared with the foreign references the renderer prefixes.
     */
    public String moduleAlias() {
        return new io.ballerina.tools.discover.model.ModuleRef(org, name).prefix();
    }
